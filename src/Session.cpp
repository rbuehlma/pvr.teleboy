...
void Session::LoginThread() {
  while (m_running) {
    ...
    std::string teleboyUsername = kodi::GetSettingString("username");
    std::string teleboyPassword = kodi::GetSettingString("password");
    m_favoritesOnly = kodi::GetSettingBoolean("favoritesonly");
    m_enableDolby = kodi::GetSettingBoolean("enableDolby");
